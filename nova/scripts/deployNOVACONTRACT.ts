...
import Counter from "../wrappers/NOVACONTRACT"; // this is the interface class from step 7
...
export async function run() {
  ...
  const mnemonic = "convince choose possible coil scare citizen guess about process aisle rather dice else slush blame dad attract attract month resist remove ecology furnace enhance"; 
